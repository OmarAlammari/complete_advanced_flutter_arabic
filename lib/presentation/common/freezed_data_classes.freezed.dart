...
class _$_ForgotPasswordObject implements _ForgotPasswordObject {
  _$_ForgotPasswordObject(this.userName, this.password);
  ...
  @override
  String toString() {
    return 'ForgotPasswordObject(userName: $userName, password: $password)';
  }
...
abstract class _ForgotPasswordObject implements ForgotPasswordObject {
  factory _ForgotPasswordObject(final String userName, final String password) =
