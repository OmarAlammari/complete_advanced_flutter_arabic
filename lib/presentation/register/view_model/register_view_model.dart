...
class RegisterViewModel extends BaseViewModel
  ...
  setUserName(String userName) {
    ...
    if (_isValid(userName, Constants.userNameCheckLength)) {
  ...
  setMobileNumber(String mobileNumber) {
    ...
    if (_isValid(mobileNumber, Constants.mobileNumberCheckLength)) {
  ...
  setPassword(String password) {
    ...
    if (_isValid(password, Constants.passCheckLength)) {
  ...
  Stream<bool> get outputIsUserNameValid => userNameStreamController.stream
      .map((userName) => _isValid(userName, Constants.userNameCheckLength));
  ...
  Stream<bool> get outputIsMobileNumberValid =>
      mobileNumberStreamController.stream.map((mobileNumber) =>
          _isValid(mobileNumber, Constants.mobileNumberCheckLength));
  ...
  Stream<bool> get outputIsPasswordValid => passwordStreamController.stream
      .map((password) => _isValid(password, Constants.passCheckLength));
  ...
  bool _isValid(String textCheck, int length) {
    return textCheck.length >= length;
  }
